-- Fix 1: Add INSERT policy for analytics table
...
-- Re-create validate_booking_availability with proper search_path
...
-- Re-create validate_machine_owner with proper search_path
...
-- Re-create validate_user_cpf_cnpj with proper search_path

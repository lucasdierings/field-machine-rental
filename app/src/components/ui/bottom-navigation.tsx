...
export const BottomNavigation = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 border-t border-border bg-background/95 pb-[env(safe-area-inset-bottom)] backdrop-blur-sm md:hidden" aria-label="Navegação principal">
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              className={cn(
                "flex flex-col items-center justify-center flex-1 min-w-[44px] gap-1 transition-colors",
                isActive
                  ? "text-primary"
